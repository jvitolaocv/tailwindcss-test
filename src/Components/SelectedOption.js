...
export default function SelectedOption(props) {
    return (
        props.terminal ?  
            ...
            : <div className="bg-blue-500 w-full h-32 rounded-lg">
                {props.text === "Encrypt!" ? <div className="flex flex-col items-center pt-8">
                ...
                {props.text === "Upload!" ? <div className="flex flex-col items-center pt-10">
